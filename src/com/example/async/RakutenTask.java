...
import com.example.adapter.RSearchListAdapter;
import com.example.data.RResponse;
import com.example.data.RResponseFactory;
import com.example.onepiecegoodsmania.R;
import com.example.web.HttpServerIF;


public class RakutenTask extends AsyncTask<String, Void, Integer>
{
...
//	private static final String AFF_ID = "0cb7b7d1.560a6e44.0cb7b7d2.99967fa5";
	...
	private RResponse mRes;

	public RakutenTask(Context context, ListView list, TextView txt)
	{
		mContext = context;
		mList = list;
		mText = txt;
	...
	protected Integer doInBackground(String... arg0)
	{
		...
		int iRet = svr.requestText(RAKUTEN_URL + PARAMS + "&keyword=" + arg0[0]);

		if(iRet == HttpStatus.SC_OK)
		{
			RResponseFactory factory = new RResponseFactory();
			mRes = (RResponse)factory.create(svr.getResText());
		}
	...
	protected void onPostExecute(Integer result)
	{
		...
		if(result == HttpStatus.SC_OK)
		{
			...
			if(mRes != null)
			{
				RSearchListAdapter adapter = new RSearchListAdapter(mContext, mRes.getItem());
